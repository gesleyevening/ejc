  ...
  module Config
    module Actions
      class Pdf < Base RailsAdmin::Config::Actions.register(self) 
            ...
            #Tudo que acontecer no PDF está aqui
            Prawn::Document.new(PDF_OPTIONS) do |pdf|
              ...
              if @object.clients.count > 0
                ...
                @object.tios.each do |c|
                  ...
                  pdf.text "Tio desde #{c.created_at.strftime("%d/%m/%y as %H:%M")}",
                    :size => 12, :align => :justify, :inline_format => true
                  pdf.move_down 8
              ...
              if @object.sales.count  0
                ...
                pdf.text "Gráfico de Tios", :size => 20, :style => :bold, :align => :center
