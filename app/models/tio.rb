class Tio < ApplicationRecord
  ...
  validates_presence_of :ano_inicio, presence: {message: 'ano deve ser informado!'},
   ...
   validates_presence_of :ano_inicio, presence: true, :numericality => {:greater_than => 2000,  message: 'Ano válido apartir de 2000!' }
   ...
   validates_presence_of :celular, presence: {message: 'não pode ser deixado em branco!'},
    ...
    validates_presence_of :email, presence: {message: 'não pode ser deixado em branco!'}, 
